...
class Repository {
  ...
  Future createUser(String username, String firstname, String lastname,
  ...
  Future signinUser(String username, String password, String apiKey) =>
      apiProvider.loginUser(username, password, apiKey);
  ...
  Future postNotification(
          int userID, int orderID, String notificationContent) =>
      apiProvider.postNotification(userID, orderID, notificationContent);
  ...
  Future getAcceptedOrderforUser() => apiProvider.getAcceptedOrderforUser();
